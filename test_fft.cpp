...
int main() {
    ...
    // RQ : Les programmes ne fonctionnent que si W,H et N sont des puissances de 2
    // (pour la 1D il suffirait d'ajouter des 0 à la fin mais plus compliqué pour la 2D ...)
